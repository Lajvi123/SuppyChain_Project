...
#Initialise Data Validation directory 
        
class DataValidationConfig:
    def __init__(self, training_pipleine_config:TrainingPipelineConfig):
        self.data_validation_dir:str = os.path.join(training_pipleine_config.artifact_dir, training_pipeline.DATA_VALIDATION_DIR_NAME)
        ...
        self.drift_report_file_path: str = os.patj.join(
